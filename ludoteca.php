				...
				<div class="inner">
					<div class="content">
						...
						<div class="highlights">
							...
							<section>
								<div class="inner">
									<a class="example-image-link" href="images/ludoteca/<?=$fila[1]?>" data-lightbox="example-set"><img class="inner" src="images/ludoteca/<?=$fila[1]?>" alt="image-1" /></a>
								</div>
							</section><?php
							}
							?>
